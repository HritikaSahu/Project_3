...
.reg {
  background: #a370d7;
    ...
    background: -webkit-linear-gradient(to right, rgba(163,112,215,1), rgba(202,40,204,1));
  
    /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    background: linear-gradient(to right, rgba(163,112,215,1), rgba(202,40,204,1))
  }
