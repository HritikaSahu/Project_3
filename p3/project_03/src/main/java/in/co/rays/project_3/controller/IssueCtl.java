...
public class IssueCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		try {
			...
			request.setAttribute("assignTop", list);
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("title"))) {
			 ...
			 * else if (!DataValidator.isInteger(request.getParameter("title"))) {
			 * request.setAttribute("title", "title must contains digit only");
		...
		if (DataValidator.isNull(request.getParameter("description"))) {
			 ...
			 * else if (!DataValidator.isInteger(request.getParameter("description"))) {
			 * request.setAttribute("description", "description must contains digit only");
			 * System.out.println(pass); pass = false;
			 * 
			 * }
			 */
		if (DataValidator.isNull(request.getParameter("status"))) {
			 ...
			 * else if (!DataValidator.isInteger(request.getParameter("status"))) {
			 * request.setAttribute("status", "Please Enter status"); pass = false; }
			 */
		 ...
		 * else if (!DataValidator.isInteger(request.getParameter("assignTo"))) {
		 * request.setAttribute("assignTo", "Please Enter assignTo"); pass = false; }
		 */
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		System.out.println(request.getParameter("openDate"));
