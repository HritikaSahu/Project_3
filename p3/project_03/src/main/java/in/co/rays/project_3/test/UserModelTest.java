...
public class UserModelTest {
	...
	public static void updateTest() throws Exception {
		...
		dto.setDob(sdf.parse("24-11-2000"));
		dto.setConfirmPassword("Hritika@123");
		dto.setPassword("Hritika@123");
		dto.setLogin("hritikasahu143@gmail.com");
