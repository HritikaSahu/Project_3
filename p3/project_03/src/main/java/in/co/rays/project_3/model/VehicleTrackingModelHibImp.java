...
public class VehicleTrackingModelHibImp implements VehicleTrackingModelInt {
	...
	public VehicleTrackingDTO findByLogin(String login) throws ApplicationException {
		...
		try {
			...
			e.printStackTrace();
			throw new ApplicationException("Exception in getting Vehicle by Login " + e.getMessage());
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in  Vehicle list");
		} finally {
			session.close();
		}
	...
	public List search(VehicleTrackingDTO dto, int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception in vehicle search");
		} finally {
			session.close();
		}
