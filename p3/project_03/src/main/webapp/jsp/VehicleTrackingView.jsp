...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/Add.jpg');
...
<body class="hm">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.VEHICLE_TRACKING_CTL%>" method="post">
			<jsp:useBean id="dto"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name=lat
											...
											oninput="handleDoubleInput(this, 'latError', 6)"
											onblur="validateDoubleInput(this, 'latError', 6)"
											oninput="numberLength(this)" step="any"
											value="<%=DataUtility.getDoublee(dto.getLat())%>"
											onkeypress="validateNumberKey(event, 'lat-validation-message')">

									</div>
									<span id="lat-validation-message"
										style="display: none; color: red;">Only number are
										allowed </span>
								</div>

								<font color="red" class="pl-sm-5" id="latError"> <%=ServletUtility.getErrorMessage("lat", request)%></font></br>
