...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.ISSUE_LIST_CTL%>" method="post">
			...
			List list1 = (List) request.getAttribute("assignTop");
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="title"
						...
						oninput="handleLetterInput(this, 'titleError', 60)"
						onblur="validateLetterInput(this, 'titleError', 60)"
...
<div class="col-sm-2"><%=HTMLUtility.getList("assignTo", String.valueOf(dto.getStatus()), list1)%></div>
