					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								...
								<%
									HashMap map = (HashMap) request.getAttribute("expertisee");
								%>
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>MobileNo</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" id="mobileNo"
											name="mobileNo" placeholder="Enter 10 digit mobile No"
											oninput="handleMobileNumberInput(this, 'mobileNoError', 10)"
											onblur="validateIntegerInput(this, 'mobileNoError', 10)"
											value="<%=DataUtility.getStringData(dto.getMobileNo())%>">

									</div>
								</div>
								<font color="red" class="pl-sm-5" id="mobileNoError"> <%=ServletUtility.getErrorMessage("mobileNo", request)%></font></br>
