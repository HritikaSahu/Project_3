			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="paymentTerm"
						placeholder="Enter payment Term" class="form-control"
						onkeypress="ValidateKey(event)" maxlength="10"
						oninput="handleIntegerInput(this, 'paymentTermError', 3)"
						onblur="validateIntegerInput(this, 'paymentTermError', 3)"
				...
				<div class="col-sm-2">
					<input type="text" name="registrationDate"
						placeholder="Enter registrationDate" id="datepicker2"
						class="form-control"
