				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Payment Term</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="paymentTerm"
											...
											oninput="handleIntegerInput(this, 'paymentTermError', 10)"
											onblur="validateIntegerInput(this, 'paymentTermError', 10)"
					...
					: DataUtility.getStringData(dto.getPaymentTerm())%>">
								...
								<font color="red" class="pl-sm-5" id="paymentTermError">
									<%=ServletUtility.getErrorMessage("quantity", request)%></font></br> <span
									class="pl-sm-5"><b>Category</b><span style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
