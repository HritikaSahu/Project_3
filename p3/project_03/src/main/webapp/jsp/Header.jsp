...
.reg {
	...
	background: -webkit-linear-gradient(to right, rgba(163, 112, 215, 1),
		rgba(202, 40, 204, 1));
	/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
	background: linear-gradient(to right, rgba(163, 112, 215, 1),
		rgba(202, 40, 204, 1))
}
</style>
</head>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			...
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: pink;">User</font>
							...
							<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										...
										<a class="dropdown-item"
											href="<%=ORSView.VEHICLE_TRACKING_CTL%>"><i
											class="fas fa-calculator"></i>Add Vehicle Tracking</a> <a
											class="dropdown-item"
											href="<%=ORSView.VEHICLE_TRACKING_LIST_CTL%>"> <i
											class="fas fa-sort-amount-down"></i>Vehicle Tracking List
									...
									<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
											...
											<div class="dropdown-menu" aria-labelledby="navbarDropdown">
												...
												<a class="dropdown-item" href="<%=ORSView.DOCTOR_CTL%>"><i
													...
													class="dropdown-item" href="<%=ORSView.DOCTOR_LIST_CTL%>">
													<i class="fas fa-sort-amount-down"></i>Doctor List
												...
												<%-- <li class="nav-item dropdown" style="padding-left: 5px"><a
													...
													aria-haspopup="true" aria-expanded="false"> <font
														style="color: white;">Inventory</font>
																...
																<%-- <li class="nav-item dropdown" style="padding-left: 5px"><a
																	...
																	<%-- 	<li class="nav-item dropdown"
																			...
																			aria-expanded="false"> <font
																				style="color: white;">Supplier</font>
																			...
																			<div class="dropdown-menu"
																				...
																				<a class="dropdown-item"
																					href="<%=ORSView.SUPPLIER_CTL%>"><i
																					class="fas fa-calculator"></i>Add Supplier</a> <a
																					class="dropdown-item"
																					href="<%=ORSView.SUPPLIER_LIST_CTL%>"> <i
																				...
																				<li class="nav-item dropdown"
																					...
																					data-toggle="dropdown" aria-haspopup="true"
																					aria-expanded="false"><font
																						style="color: white;"><%=welcomeMsg%> </font></a>
																					<div class="dropdown-menu"
																						aria-labelledby="navbarDropdown">
																						<%
																							if (userLoggedIn) {
																						...
																						<a class="dropdown-item"
																							...
																							class="fas fa-user-tie"></i>My Profile</a> <a
																							class="dropdown-item"
																							href="<%=ORSView.CHANGE_PASSWORD_CTL%>"> <i
																						...
																						<a class="dropdown-item"
																							...
																							href="<%=ORSView.USER_REGISTRATION_CTL%>"><i
																								class="fas fa-registered"><b> User
																										Registration</b></i></a>
																					</div></li>
																				<%
																					}
