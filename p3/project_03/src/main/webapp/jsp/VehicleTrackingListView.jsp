...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.VEHICLE_TRACKING_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="number" name="lat" placeholder="Enter latitude"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">Latitude</th>
							<th width="20%" class="text">VehicleId</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><a
								href="VehicleTrackingCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">VehicleTrackings
					List</h1>
			</center>
			</br>
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=VehicleTrackingListCtl.OP_BACK%>">
				</div>
