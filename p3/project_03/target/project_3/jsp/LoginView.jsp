...
.grad {
	background-image: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(185,62,201,0.9613095238095238) 35%, rgba(30,203,238,1) 100%);
...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/LoginPage.jpg');
